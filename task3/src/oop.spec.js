...
describe('ООП', () => {
    describe('#Point', () => {
        ...
        it('расстояние от точки до центра вычисляется корректно', () => {
            const point1 = new core.Point(3, 4);
            assert.strictEqual(point1.distanceToCenter(), 5);

            const point2 = new core.Point(-3, 4);
            assert.strictEqual(point2.distanceToCenter(), 5);

            const point3 = new core.Point();
            assert.strictEqual(point3.distanceToCenter(), 0);

            const point4 = new core.Point(0, 5);
            assert.strictEqual(point4.distanceToCenter(), 5);
        });
    });
